...
class Cell:
    ...
    def draw(self):
        ...
        if self.visited:
            pygame.draw.rect(screen, pygame.Color('green'), (x, y, TILE, TILE))

        if not self.walls['top']:
            pygame.draw.rect(screen, pygame.Color('green'), (x, y - TILE, TILE, TILE))
        if not self.walls['right']:
            pygame.draw.rect(screen, pygame.Color('green'), (x + TILE, y, TILE, TILE))
